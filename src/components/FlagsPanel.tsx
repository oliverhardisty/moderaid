...
export const FlagsPanel: React.FC<FlagsPanelProps> = ({ 
  ...
  return (
    <Tabs defaultValue="ai-flags" className="h-full flex flex-col">
      <TabsList className="fixed grid w-full grid-cols-3 bg-transparent p-0 h-auto border-b border-gray-200 flex-shrink-0">
        <TabsTrigger value="ai-flags" className="bg-transparent border-0 rounded-none pb-3 px-4 data-[state=active]:bg-transparent data-[state=active]:shadow-none data-[state=active]:border-b-2 data-[state=active]:border-purple-600 data-[state=active]:text-purple-600 text-gray-500 font-medium z-[-1]">AI flags</TabsTrigger>
