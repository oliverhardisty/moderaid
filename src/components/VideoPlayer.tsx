       ...
       <div className="bg-white p-4 space-y-2">
         ...
         <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              >
                {isPlaying ? (
                  <Pause className="w-6 h-6" fill="hsl(var(--primary))" stroke="none" />
                ) : (
                  <Play className="w-6 h-6" fill="hsl(var(--primary))" stroke="none" />
                )}
              </button>
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  {volume > 0 ? (
                    <Volume2 className="w-6 h-6" fill="hsl(var(--primary))" stroke="none" />
                  ) : (
                    <VolumeX className="w-6 h-6" fill="hsl(var(--primary))" stroke="none" />
                  )}
                </button>
