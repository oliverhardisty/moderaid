          ...
          <div className="absolute inset-0 bg-gray-900/50 backdrop-blur-lg flex items-center justify-center">
            <div className="text-center text-white p-8">
              ...
              <p className="text-sm text-gray-300 mb-6">
                This content has been identified as potentially sensitive material
              </p>
              <button
                onClick={onUnblur}
                className="px-3 py-1.5 bg-white border border-purple-600 hover:bg-purple-50 text-purple-600 font-medium rounded-lg text-sm transition-colors flex items-center gap-2 mx-auto"
              >
         ...
         <div className="flex items-center justify-between">
           ...
           <div className="flex items-center gap-2">
             ...
             >
                ...
                {isBlurred ? 'Unblur content' : 'Blur content'}
             </button>
             <button 
